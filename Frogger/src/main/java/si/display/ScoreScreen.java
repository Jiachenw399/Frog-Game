...
public class ScoreScreen implements Screen {
    ...
    public void paint() {
        ...
        gc.fillText("Frogger Game Hall of Fame", FroggerGame.SCREEN_WIDTH/2, FroggerGame.SCREEN_HEIGHT / 10);
        ...
        gc.setTextBaseline(VPos.CENTER);
        gc.setFont(new Font("Arial", 28));
        gc.fillText("Press 'M' to return to the Main Menu", FroggerGame.SCREEN_WIDTH/2, FroggerGame.SCREEN_HEIGHT / 10 * 9);
    }
}